...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.animeexpeditions.online'
  const path = '/about'

  return {
    title: 'About Anime Expeditions Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Anime Expeditions Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Anime Expeditions Roblox game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'About Anime Expeditions Wiki',
      description: 'Learn about our mission to provide the best Anime Expeditions game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Anime Expeditions Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Anime Expeditions Wiki',
      description: 'Learn about our mission to provide the best Anime Expeditions game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Anime Expeditions Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Anime Expeditions
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Anime Expeditions Wiki</h2>
            <p>
              Anime Expeditions Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Roblox game "Anime Expeditions". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Anime Expeditions Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Anime Expeditions players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Anime Expeditions Wiki as the <strong>go-to destination</strong> for every Anime Expeditions player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Expeditions Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Anime Expeditions Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Anime Expeditions as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Anime Expeditions mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Anime Expeditions Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Anime Expeditions or any official entities.
            </p>
            <p>
            ...
            <p>
              Anime Expeditions Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@animeexpeditions.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@animeexpeditions.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@animeexpeditions.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@animeexpeditions.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@animeexpeditions.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@animeexpeditions.online
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@animeexpeditions.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@animeexpeditions.online
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Anime Expeditions news.
