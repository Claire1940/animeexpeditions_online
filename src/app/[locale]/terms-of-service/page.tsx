...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Anime Expeditions Wiki",
    description: "Read the Terms of Service for Anime Expeditions Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Anime Expeditions Wiki",
      description: "Terms and conditions for using Anime Expeditions Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Anime Expeditions Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Anime Expeditions Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Anime Expeditions Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Anime Expeditions Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Anime Expeditions". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Anime Expeditions Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Anime Expeditions. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Anime Expeditions Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Anime Expeditions. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Game access, events, and updates may change without notice. We are not responsible for game access or content changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ANIME EXPEDITIONS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Anime Expeditions Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@animeexpeditions.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@animeexpeditions.online</a>
            </p>
            <p>
